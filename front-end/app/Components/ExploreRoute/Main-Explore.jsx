...
const NAV = [
  ...
  { id: "post",   label: "Post",   href: "/Post", icon: <><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></> },
  { id: "people", label: "People", href: "/Explore", icon: <><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></> },
...
function Avatar({ name }) {
  ...
  return (
    <div className={`w-11 h-11 rounded-xl flex items-center justify-center
                     text-[15px] font-semibold border ${color} shrink-0`}>
      {initials}
    </div>
  );
}
    ...
    <div className="min-h-screen bg-[#0b0f1a] relative overflow-hidden flex">
      ...
      <div className="flex-1 overflow-y-auto min-w-0">
        ...
        <div className="relative z-10 flex items-center gap-3 px-4 py-3
                        bg-[#0b0f1a]/80 border-b border-white/[0.06] md:hidden">
          <button
            onClick={() => setMobileSidebarOpen(true)}
            className="w-8 h-8 flex items-center justify-center rounded-md border border-white/10
                       text-gray-500 hover:bg-white/5 hover:text-blue-400 transition-colors">
            <Icon size={14}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-14">
          ...
          <div className="mb-8 sm:mb-10 text-center">
            <span className="inline-block px-4 py-1 text-[12px] rounded-full
                             bg-white/5 text-gray-400 border border-white/10 mb-4">
              Explore Developers
            </span>
            <h1 className="text-2xl sm:text-3xl font-bold text-white tracking-tight">
              Find your people
            </h1>
            <p className="mt-2 text-gray-500 text-[13px] sm:text-[14px]">
              Search across the community and connect with developers
            </p>
          </div>
          ...
          <div className="relative mb-6 max-w-xl mx-auto">
            ...
            <input
              ...
              className="w-full pl-10 pr-24 py-3 rounded-xl bg-white/[0.05] border border-white/10
                         text-white placeholder-gray-600 text-[14px] outline-none
                         focus:border-blue-500/50 focus:bg-white/[0.07] transition-all"
            />
            <button
              onClick={fetchUsers}
              className="absolute right-2 top-1/2 -translate-y-1/2 px-3.5 py-1.5 rounded-lg
                         bg-blue-600/80 hover:bg-blue-500 text-white text-[12px] font-medium
          ...
          {/* error */}
          {error && (
            <div className="max-w-xl mx-auto mt-4 px-4 py-3 rounded-xl
                            bg-red-500/10 border border-red-500/20 text-red-400 text-[13px] text-center">
              {error}
            </div>
          )}
            ...
            <>
                ...
                {filtered.map(user => (
                  ...
                  >
                    ...
                    <div className="text-gray-700 group-hover:text-blue-500
                                    group-hover:translate-x-0.5 transition-all mt-0.5 shrink-0">
              ...
              {filtered.length === 0 && (
                <div className="text-center py-16 text-gray-600">
                  <svg className="mx-auto mb-3 opacity-40" width="36" height="36" viewBox="0 0 24 24"
                       fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                    <circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/>
                  </svg>
                  <p className="text-[14px]">
                    No users match <span className="text-gray-400">"{query}"</span>
                  </p>
          ...
          {!searched && !loading && (
            <div className="text-center py-16 text-gray-700">
              <svg className="mx-auto mb-3 opacity-30" width="36" height="36" viewBox="0 0 24 24"
                   fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/>
              </svg>
              <p className="text-[13px]">
                Type a name or email and press{" "}
